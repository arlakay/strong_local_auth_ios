...
class AuthOptions {
  ...
  static AuthOptions decode(Object result) {
    ...
    return AuthOptions(
      ...
      strongMode: result[1]! as bool,
      sticky: result[2]! as bool,
      useErrorDialogs: result[3]! as bool,
    );
  }
}
...
class LocalAuthApi {
  ...
  Future<bool> isDeviceSupported() async {
    const String channelName = 'dev.flutter.pigeon.local_auth_ios.LocalAuthApi.isDeviceSupported';
  ...
  Future<bool> deviceCanSupportBiometrics() async {
    const String channelName = 'dev.flutter.pigeon.local_auth_ios.LocalAuthApi.deviceCanSupportBiometrics';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
  ...
  Future<List<AuthBiometricWrapper?>> getEnrolledBiometrics() async {
    const String channelName = 'dev.flutter.pigeon.local_auth_ios.LocalAuthApi.getEnrolledBiometrics';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
  ...
  Future<AuthResultDetails> authenticate(AuthOptions arg_options, AuthStrings arg_strings) async {
    const String channelName = 'dev.flutter.pigeon.local_auth_ios.LocalAuthApi.authenticate';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
